...
|---|---|---|
| [Methsara Publications - E-commerce Bookstore](https://github.com/sarasithagalagama/Methsara-Publications) | Full-stack bookstore with product catalogue, cart, wishlist, checkout, order management, inventory workflows, authentication, and admin dashboard. | React 18, Redux Toolkit, Tailwind CSS, Node.js, Express.js, MongoDB |
